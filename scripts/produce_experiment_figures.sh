...
if [ "$experiment" != "" ] && [ "$dataset" != "" ]; then
  ...
  then
    ...
    multiresticodm plot -d ./data/outputs/$dataset/$experiment -p 20 -b 5000 -xfq 5 -fs 15 5 -ff png
    # Produce parameter histogram
    multiresticodm plot -d ./data/outputs/$dataset/$experiment -p 22 -b 5000 -nb 500 -ff png
    # Produce parameter 2d contour
    multiresticodm plot -d ./data/outputs/$dataset/$experiment -p 21 -b 5000 -fs 5 5 -ms 10 -ff png
    # Produce parameter autocorrelation plot
    multiresticodm plot -d ./data/outputs/$dataset/$experiment -p 23 -b 5000 -fs 10 5 -nb 200 --benchmark -ff png
    # Produce log destination attraction predictions and residual plots
    multiresticodm plot -d ./data/outputs/$dataset/$experiment -p 31 -p 32 -b 5000 -fs 5 5 -ms 20 -ff png
    # Produce posterior table mean convergence to ground truth
    multiresticodm plot -d ./data/outputs/$dataset/$experiment -p 02 -b 0 -fs 10 10 -no relative_l_1 -ff png
