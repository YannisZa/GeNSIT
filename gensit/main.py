...
_run_and_optimise_options = [
        ...
        default = None, help = 'Overwrites input region features filename in config'),
...
_output_options = [
    ...
    click.option('--slice/--no-slice', default = False, is_flag = True, show_default = True,
              help = f'Flag for whether coordinate and index slicing should be applied to stored data collection.'),
